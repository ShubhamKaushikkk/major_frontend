...
const Home = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://major-backend-ealt.onrender.com/api/v0/registeredusers`)
      .then((res) => {
        // console.log(res);
    ...
    axios
      .get(`https://major-backend-ealt.onrender.com/api/v0/getvotes`)
      .then((res) => {
        // console.log(res);
  ...
  useEffect(() => {
    axios
      .get(`https://major-backend-ealt.onrender.com/api/v0/recentregistrations`)
      .then((res) => {
        // console.log(res);
